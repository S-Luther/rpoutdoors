...
const stripe = new Stripe('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', {
...
exports.createStripePayment = functions.firestore
  ...
  .onCreate(async (snap, context) => {
    const { amount, currency, payment_method, receipt_email} = snap.data();
    try {
      ...
      const payment = await stripe.paymentIntents.create(
        {
          ...
          receipt_email: receipt_email || customerObj.email,
        },
        { idempotencyKey }
      );
